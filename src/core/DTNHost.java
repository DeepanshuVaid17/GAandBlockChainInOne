...
public class DTNHost implements Comparable<DTNHost> {
	...
	private Map<String,List<Coord>> coordsById;
	private Map<String,List<String>> neighbours;
	private Coord location; 	// where is the host
	private Coord destination;	// where is it going
	private String groupId;// THE GROUP IN WHICH NODE BELONGS
	...
	public DTNHost(List<MessageListener> msgLs,
		...
		this.isWorkingDayMovement = false;
	...
	public Map<String,List<Coord>> getCoordsById() {
		return coordsById;
	}

	public void setCoordsById(Map<String,List<Coord>> coordsById) {
		this.coordsById = coordsById;
	}

	public Map<String,List<String>> getNeigbours() {
		return neighbours;
	}

	public void setNeigbours(Map<String,List<String>> neighbours) {
	...
	public int getIsItAStationary() {
		return isItAStationary;
	}

	public void setIsItAStationary(int isItAStationary) {
		this.isItAStationary = isItAStationary;
	}
	
	public boolean isMessageUnchanged(Message message){
